...
public class lab_51 {
	...
	private void initialize() {
		...
		textArea_1.setBounds(258, 13, 834, 83);
		...
		button_1.setBounds(53, 456, 150, 25);
		...
		button_2.setBounds(53, 494, 150, 25);
		frame.getContentPane().add(button_2);
		
		panel = new Panel_output();
		panel.setBackground(Color.WHITE);
		panel.setBounds(258, 109, 834, 677);
		frame.getContentPane().add(panel);
		
		JButton button_3 = new JButton("Схема днф");
		button_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				
			}
		});
		button_3.setBounds(53, 532, 150, 25);
